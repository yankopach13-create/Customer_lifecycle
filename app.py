        ...
        if not cohorts_to_use_c:
            ...
            if not cohort_clients_c:
                ...
                cluster_table_html = (
                    ...
                    "body { font-family: 'Source Sans 3', 'Source Sans Pro', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 1rem; margin: 0; padding: 0.5rem; background: #343a40; color: #fff; }\n"
                    ".cluster-table-wrap { margin: 0.5rem 0; min-height: 400px; max-height: 85vh; overflow-y: auto; overflow-x: hidden; width: 100%; max-width: 100%; background: #343a40; padding: 1rem; border-radius: 8px; }\n"
                    ".cluster-table { width: 100%; max-width: 100%; table-layout: fixed; border-collapse: collapse; font-size: 1rem; "
                    "border: 1px solid #dee2e6; border-radius: 8px; background: #343a40; color: #fff; }\n"
                    ".cluster-table thead th { position: sticky; top: 0; z-index: 100; box-sizing: border-box; "
                    "background: #343a40; color: #fff; font-weight: 600; letter-spacing: 0.02em; padding: 0.6rem 1rem; text-align: left; "
                    "font-size: 1rem; line-height: 1.3; word-wrap: break-word; overflow-wrap: break-word; "
                    "border: 1px solid #dee2e6; border-bottom: 1px solid rgba(255,255,255,0.35); }\n"
                    ...
                    ".cluster-table td { padding: 0.5rem 1rem; border: 1px solid #dee2e6; background: #343a40; color: #fff; vertical-align: middle; font-size: 1rem; line-height: 1.4; "
                    ...
                    ".cluster-details-wrap summary { list-style: none; cursor: pointer; font-size: 1rem; line-height: 1.3; }\n"
                    ".cluster-details-wrap summary::-webkit-details-marker { display: none; }\n"
                    ".cluster-arrow { display: inline-block; margin-right: 4px; font-size: 0.75rem; color: rgba(255,255,255,0.7); }\n"
                    ".cluster-details-wrap[open] .cluster-arrow { transform: rotate(90deg); }\n"
                    ".cluster-details-row td { padding: 0; border: 1px solid #dee2e6; background: #343a40; vertical-align: top; }\n"
                    ".cluster-details { padding: 1rem 1.25rem; background: rgba(255,255,255,0.1); color: #fff; "
                    "border-left: 3px solid #e85d04; font-size: 0.95rem; line-height: 1.45; border-radius: 4px; }\n"
                    ...
                    ".cluster-detail-block strong { font-weight: 600; font-style: italic; display: block; margin-bottom: 0.25rem; }\n"
                    ".cluster-detail-block:first-child strong { color: #b19cd9; }\n"
                    ".cluster-detail-block:last-child strong { color: #e85d04; }\n"
                    "@media (max-width: 640px) { .cluster-details-inner { grid-template-columns: 1fr; } }\n"
                    ".cluster-table tbody tr:hover td { background: rgba(255,255,255,0.08); }\n"
