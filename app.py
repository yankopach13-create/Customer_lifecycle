        ...
        if not cohorts_to_use_c:
            ...
            if not cohort_clients_c:
                ...
                cluster_table_html = (
                    ...
                    ".cluster-table td { padding: 5px 10px; border: 1px solid #dee2e6; background: #e2e6ea; color: #212529; vertical-align: middle; font-size: 0.9375rem; line-height: 1.35; "
                    ...
                    ".cluster-details-row td { padding: 0; border: 1px solid #dee2e6; background: #e2e6ea; vertical-align: top; }\n"
                    ".cluster-details { padding: 10px 14px; background: #dee2e6; color: #212529; "
