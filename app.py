        ...
        if not cohorts_to_use_c:
            ...
            if not cohort_clients_c:
                ...
                st.markdown(
                        ...
                        '.cluster-details {{ margin-top: 10px; padding: 0.75rem 1rem; background: #343a40; color: #fff; '
                        'border: 1px solid #dee2e6; border-radius: 8px; font-size: 0.75rem; text-align: left; }} '
                        '.cluster-detail-block {{ margin-bottom: 0.5rem; padding-bottom: 0.5rem; border-bottom: 1px solid rgba(255,255,255,0.25); }} '
                        '.cluster-detail-block:last-child {{ margin-bottom: 0; padding-bottom: 0; border-bottom: none; }} '
                        '.cluster-detail-block strong {{ color: #e85d04; font-weight: 600; }} '
