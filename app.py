        ...
        if not cohorts_to_use_c:
            ...
            if not cohort_clients_c:
                ...
                cluster_table_html = (
                    ...
                    "body { font-family: 'Source Sans 3', 'Source Sans Pro', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; font-size: 1rem; margin: 0; padding: 0.5rem; background: #000; color: #e0e0e0; }\n"
                    ".cluster-table-wrap { margin: 0.5rem 0; min-height: 400px; max-height: 85vh; overflow-y: auto; overflow-x: hidden; width: 100%; max-width: 100%; background: #000; padding: 8px; border-radius: 8px; }\n"
                    ".cluster-table { width: 100%; max-width: 100%; table-layout: fixed; border-collapse: collapse; font-size: 0.9375rem; "
                    "border: 1px solid #333; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.4); background: #000; color: #e0e0e0; }\n"
                    ".cluster-table thead th { position: sticky; top: 0; z-index: 100; box-sizing: border-box; "
                    "background: #1a1a1a; color: #fff; font-weight: 600; padding: 6px 10px; text-align: left; "
                    "font-size: 0.9375rem; box-shadow: 0 2px 2px rgba(0,0,0,0.3); line-height: 1.3; "
                    "word-wrap: break-word; overflow-wrap: break-word; border: 1px solid #333; }\n"
                    ...
                    ".cluster-table td { padding: 5px 10px; border: 1px solid #333; background: #000; color: #e0e0e0; vertical-align: middle; font-size: 0.9375rem; line-height: 1.35; "
                    ...
                    ".cluster-arrow { display: inline-block; margin-right: 4px; font-size: 0.7rem; color: #9e9e9e; }\n"
                    ".cluster-details-wrap[open] .cluster-arrow { transform: rotate(90deg); }\n"
                    ".cluster-details-row td { padding: 0; border: 1px solid #333; background: #0d0d0d; vertical-align: top; }\n"
                    ".cluster-details { padding: 10px 14px; background: #1a1a1a; color: #e0e0e0; "
                    ...
                    ".cluster-detail-block:last-child strong { color: #ffb366; }\n"
                    "@media (max-width: 640px) { .cluster-details-inner { grid-template-columns: 1fr; } }\n"
                    ".cluster-table tbody tr:hover td { background-color: #1a1a1a; }\n"
                    ".cluster-table tbody tr:first-child td { background: rgba(128, 0, 128, 0.45) !important; color: #fff !important; font-weight: bold; }\n"
