        ...
        if not cohorts_to_use_c:
            ...
            if not cohort_clients_c:
                ...
                st.markdown(
                        ...
                        '.cluster-details {{ margin-top: 10px; padding: 10px 10px 10px 12px; background: #f8f9fa; border-radius: 6px; '
                        'border-top: 1px solid #dee2e6; border-left: 3px solid #6c757d; font-size: 0.75rem; text-align: left; '
